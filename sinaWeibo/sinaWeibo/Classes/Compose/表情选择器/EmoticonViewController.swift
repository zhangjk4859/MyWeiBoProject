...
private let JKEmoticonCellReuseIdentifier = "JKEmoticonCellReuseIdentifier"
class EmoticonViewController: UIViewController {
    ...
    private lazy var collectionVeiw: UICollectionView = {
        ...
        // 注册cell
        clv.registerClass(EmoticonCell.self, forCellWithReuseIdentifier: JKEmoticonCellReuseIdentifier)
        clv.dataSource = self
        clv.delegate = self
        return clv
    }()
...
extension EmoticonViewController: UICollectionViewDataSource, UICollectionViewDelegate
{
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cell = collectionVeiw.dequeueReusableCellWithReuseIdentifier(JKEmoticonCellReuseIdentifier, forIndexPath: indexPath) as! EmoticonCell
